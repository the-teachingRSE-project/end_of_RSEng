...
Nonetheless, as the use of digital tools becomes ever more pervasive in a researcher's day-to-day tasks, there are already people suggesting that RSEng will
cease to exist as a separate field, and the specialist skills that Research Software Engineers(RSEs) provide to support and undertake research will
become a core part of the tooling and skill set of researchers in almost all other domains.
Are we already approaching ``the end of Research Software Engineering''?!
While we believe that it is certainly too early to already herald the demise of RSE as a separate field,
we also recognise the need to acknowledge that the future is in constant flux and
it is worthwhile discussing how RSEng will/could change in response to these upcoming challenges.
To figure out these challenges of the future we held a workshop and structured the resulting discussion around social, technological, and organisational aspects.
...
\begin{itemize}
\item The evolution of the term RSE and its definition
\item Growth and development of the RSE community
\item The impact of automation and generative artificial intelligence in RSE work
\item The impact of complexity and usability in research software
\item Ethics and social considerations
\item The transformations expected in academic institutions
\item Impact of alternative career paths for RSEs and other RTPs(\emph{Research Technical Professional}s)
\end{itemize}
...
On the other hand the existence of people with a certain specialised skillset opens up possiblities for pooling.
