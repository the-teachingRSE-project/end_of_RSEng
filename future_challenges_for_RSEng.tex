...
and the transformations expected in the research organisations,
...
We also hope, that Research Software becomes an accepted research artifact on equal footing as data and publications.
...
With increased numbers the visibility of the RSE community also to industry will become higher.
...
Kim develops advanced scientific software in tandem with an AI agent that codes, debugs, and simulates experiments alongside her. The AI proactively suggests optimisations, generates reproducible workflows, and adapts to Kim’s coding style and domain-specific needs. With this partnership, Kim accelerates her research output while maintaining full control over scientific direction and ethical oversight.
\end{story}
...
strategies of the political actors. We also hope, that Data Awareness and Data Protection are also still values
that are protected.
\end{whatis}
...
Similar to RSEs, that are known by 2035 in university boards, we expect the concept of RSE units to be in the minds
...
This is an opportunity that would not be possible by short-term funded solo RSEs.
...
While networking embedded RSEs and RSE units is essential for building robust, sustainable research software infrastructure, but the question arises whether every group truly needs to host and manage its own infrastructure.
...
as long-term funding is more difficult to acquire in lower levels of an organisation.
...
The material presented here, is based on a workshop, bt extended with the author's ideas.
Nevertheless there are some things that we declared out of scope here.
Among that is the digital transformation in the wider society.
...
There are also some trends that believe to stay with us.
...
We hope that the standard of research software has risen across the board to enable an easy reuse in new research.
We hope that a cultural change is taking place to recognize research software as the integral part of science that it is
within broad parts of academia and is supported by political actors.
