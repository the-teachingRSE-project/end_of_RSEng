...
more secure employment in this environment.
\end{story}

\subsection{What are new tasks of RTPs?}
 FG-NOTE: RSEs are one type of specialization of RTPs in science. Do we see any other?
...
\subsection{Impact of Alternate Career Paths for Researchers on the Structure of Research Institutes}
The RSE is probably one of the first professionalizations in the academic midlevel that is able
