...
to enhance and address problems with research code, that can often make up the bulk of
...
We also hope that specialised clusters form, which pool the skills of certain specialised RSEs with certain RSE units specialising in certain tasks like data management, HPC, or visualisation.
