...
\item Impact of alternative career paths for RSEs and other RTPs
\end{itemize}
...
However, when these tools are used in practice many users report increased cognitive load and frustration stemming from the difficulty to prompt the system effectively and debugging the generated code \cite{Simkute2025}.
...
more secure employment in this polarised world.
\end{story}
