...
deployment of their code. Again, all these skills will, we anticipate, be gained as part of training
infrastructure that will provide domain scientists with software development expertise as part of their
core scientific training.

So where do RSEs fit into this picture? We expect to see RSEs providing technical skills and input
to research activities in range of different areas, including the following:
\begin{itemize}
